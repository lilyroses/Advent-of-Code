# Solution 2 - Advent of Code 2015, Day 21
...
def main():
    ...
    def lose(boss_hp, boss_dmg, boss_armor,
  ...
  #            equipment_loadouts.append([weapon, armor_name, ring_combo])
    ...
    gold_spent_to_lose = 0

    for stats in loadout_stats:
        cost, player_dmg, player_armor = stats
        if lose(boss_hp, boss_dmg, boss_armor,
                 player_hp, player_dmg, player_armor):
          if gold_spent_to_lose == 0:
              gold_spent_to_lose = cost
          else:
              gold_spent_to_lose = max(gold_spent_to_lose, cost)

    print(gold_spent_to_lose)
